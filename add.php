        ...
        <div class="card shadow bg-body-tertiary rounded mb-4 ">
            <div class="card-body">
                <form action="insert.php" method="post">
                    <input class="form-control me-2 mb-4" required name="title_note" placeholder="JUDUL...">
                    <input class="form-control me-2 mt-4" required name="note_note" placeholder="ISINYA.......">
